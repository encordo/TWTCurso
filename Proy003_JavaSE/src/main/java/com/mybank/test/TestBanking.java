...
public class TestBanking {
	...
	public static void main(String[] args) {
		System.out.println("Customer [Simms, Jane] has a checking balance of 200.0 with a 500.00 overdraft protection.");
		...
		try {
			...
			System.out.println("Customer [Bryant, Owen] has a savings balance of 200.0");
