...
public class BaseDatosMercado {
	...
	static {
		...
		tablaProducto.put(1, new Producto(1, "Libro Rectas", 30.0,5));
		tablaProducto.put(2, new Producto(2, "Jarrón Chino", 340.0,5));
		tablaProducto.put(3, new Producto(3, "Lápiz", 3.0,5));
	...
	public static void add(String nombre, double precio) {
		int newId = ++contador;
		Producto newP = new Producto(newId, nombre,precio,5);
